...
class Ui_TabContent(object):
    def setupUi(self, TabContent):
        ...
        TabContent.resize(492, 181)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(TabContent.sizePolicy().hasHeightForWidth())
        TabContent.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tamano_de_seleccion_spinBox.sizePolicy().hasHeightForWidth())
        self.tamano_de_seleccion_spinBox.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pos_x_label.sizePolicy().hasHeightForWidth())
        self.pos_x_label.setSizePolicy(sizePolicy)
